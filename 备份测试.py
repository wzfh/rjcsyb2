...
class MY_GUI(tk.Tk):
    ...
    def getMon2(self, items):
        ...
        if inits == "报警数据":
            ...
            self.ssuo_data_label11.grid_remove()
            self.ssuo_data_Text11.grid_remove()
            self.szhan_data_label11.grid_remove()
            self.szhan_data_Text11.grid_remove()
        ...
        if inits == "穿戴轨迹" or inits == "Wearable Track":
            ...
            items = (
                ...
                "Health Parameters Report", "Call Record Report")
            self.zd_data_label11.grid(row=14, column=0, sticky=N)
            self.zd_data_Text11.grid(row=15, column=0, columnspan=10, sticky=N)
            self.zd_data_Text11.delete(0, 20)
            self.repower_data_label11.grid_remove()
    ...
    def set_init_window(self):
        ...
        items = (f"{self.xszip}", f"{self.conf_scwg}", "81.71.67.36", "120.79.176.183")
