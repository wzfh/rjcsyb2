...
class App(customtkinter.CTk):
    ...
    def 车辆id(self):
        ...
        querystring = {"keyword": f"{int(self.sb_hao())}", "groupId": f"{int(self.groupId)}", "state": "0",
                       "childFlag": "1",
                       "pageNumber": "1",
                       "pageSize": "10"}
        print(querystring)
    ...
    def wzhi部标(self):
        ...
        if self.api_on():
            ...
            self.groupId1 = self.group1()
            if self.baojpd(报警) is None:
                self.textbox.insert(1.0, '\n平台没有对应的报警类型\n\n')
            else:
                self.countdown(5)
                self.textbox.insert(1.0, self.alam(报警))
        else:
            pass
        return ''
    ...
    def select_frame_by_name(self, name):
        ...
        self.sidebar_button_2.configure(fg_color=("gray75", "gray25") if name == "home" else "transparent")
    ...
    def __init__(self):
        ...
        self.ico_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "cache.png")), size=(26, 26))
        ...
        self.group_Text1.insert(0, "550452")
        self.group_Text1.grid(row=6, column=0, padx=(15, 10), sticky="nsew")

        self.group_Text_label = customtkinter.CTkLabel(self.sidebar_frame, text="登录账号",
                                                       font=customtkinter.CTkFont(size=13), fg_color="transparent")
        self.group_Text_label.grid(row=7, column=0, padx=(15, 10), sticky="nsew")
        self.group_Text1 = customtkinter.CTkEntry(self.sidebar_frame)
        self.group_Text1.insert(0, f"{self.user}")
        self.group_Text1.grid(row=8, column=0, padx=(15, 10), sticky="nsew")
        #
        self.group_Text_label = customtkinter.CTkLabel(self.sidebar_frame, text="加密密码",
                                                       font=customtkinter.CTkFont(size=13), fg_color="transparent")
        self.group_Text_label.grid(row=9, column=0, padx=(15, 10), sticky="nsew")
        self.group_Text1 = customtkinter.CTkEntry(self.sidebar_frame)
        self.group_Text1.insert(0, f"{self.password}")
        self.group_Text1.grid(row=10, column=0, padx=(15, 10), sticky="nsew")
    ...
    def myframe1(self):
        ...
        self.switch = customtkinter.CTkSwitch(master=self.my_frame, text=f"报警查询(前2条)",
                                              font=customtkinter.CTkFont(size=13),
        ...
        self.baoji_Text.grid(row=7, column=0, padx=(15, 10), sticky="nsew")
        ...
        self.type_Text.grid(row=7, column=2, padx=(15, 10), sticky="nsew")
        ...
        self.ztai_Text.grid(row=7, column=1, padx=(15, 10), sticky="nsew")
...
if __name__ == "__main__":
    ...
    if runs == 1:
        ...
        expiration_date = now + datetime.timedelta(days=int(f'184'))
    ...
    if now > expiration_date:
        ...
        messagebox.showwarning(title="软件过期提醒", message=f"\n软件程序已过期，无法启动\n")
        while True:
            if check_double_press("end"):
                try:
                    ...
                    pass
                app.attributes('-topmost', True)
                messagebox.showwarning(title="欢迎超级管理员", message=f"\n已额外授权使用\n")
                break
        os._exit(2)
    else:
        app.mainloop()
