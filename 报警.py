...
class login:
    ...
    def get4(self):
        ...
        下车时间 = 上车 + 上车时间[8:]
        nums = [
            f'0B050073{self.sbei905}0018000000000000030000C640B903F7CAAC00C817{时间}000000000000030000C7138E03F5BF7C00C817{时间}3590AA283590AA280100000000000{random.randint(0, 9)}534E31323535534E3132333435363738393100000000534E3132333435363738393132333435363738{上车时间1}{下车时间}000{random.randint(52, 56)}001800001600150000160000000020301040000006E0202044C250400000000300103'
        ]
        for w in nums:
            a = get_xor(w)
            b = get_bcc(a)
    ...
    def get7(self):
        ...
        nums = [
            ...
            f'0B0500730153698544110015000000000000030000C640B903F7CAAC00C814{时间}000000000000030000C715BE03F5BF3800C818{时间}3590AA283590AA280100000000000{random.randint(0, 9)}534E31323535534E3132333435363738393100000000534E3132333435363738393132333435363738{上车时间1}{下车时间}00031002100001700160000170000000020301040000006E0202044C250400000000300103'
        ]
        for w in nums:
            a = get_xor(w)
            b = get_bcc(a)
